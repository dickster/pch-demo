(function($) {
    ...
    $.widget( "wtw.changePanel", {
        ...
        _activate : function($changeItem, showPopup) {
            ...
            this._trigger('select', null, [this.options.changesById[changeId], showPopup]);
        },
        ...
        _set : function($toggle,index) {
            ...
            var change = this.options.changesById[id];
        ...
        changeAdded : function(id, change, value) {
            ...
            throw 'TODO : need to fix changeAdded to work with hierarchical data!!!!!!';

            this.options.changesById[change.id] = change;
            var config = this.options.config;
        ...
        sortChanges: function() {
            ...
            // TODO : this doesn't work for hierarchical data right now.  (easy sections don't have idAttr attached yet).
        ...
        _updateChanges : function(index) {
            ...
            $.each(self.options.changes, function(i,change) {
                var value;
                if (change.type=='container') return;
